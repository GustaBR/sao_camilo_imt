...
import 'nutricionista_detalhes_page.dart';

class NutricionistaListaPage extends StatefulWidget {
  final String profissionalId;
  final String profissionalNome;
  const NutricionistaListaPage({super.key, required this.profissionalId, required this.profissionalNome});

  @override
  State<NutricionistaListaPage> createState() => _NutricionistaListaPageState();
}
                  ...
                  child: ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => NutricionistaDetalhesPage(
